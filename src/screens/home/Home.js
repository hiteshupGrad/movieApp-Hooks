...
const Home = (props) => {
  ...
  useEffect(() => {
    // Get upcoming movies
    getUpcomingMovies(setUpcomingMovies, props);
    // Get released movies
    getReleasedMovies(setReleasedMovies, props);
    // Get Genres
    getGenres(setGenresList, props);
    // Get artists
    getArtists(setArtistsList, props);
  }, []);

  const getArtists = (setArtistsList) => {
  ...
  const getReleasedMovies = (setReleasedMovies) => {
